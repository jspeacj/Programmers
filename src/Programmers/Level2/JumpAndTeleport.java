...
public class JumpAndTeleport {
    public static void main(String[] args) {
        /*
            ...
            규칙 : 순간이동은 현재이동거리 x 2이며, 순간이동을 최대한 많이한 방법이 건전지 사용량의 최솟 값입니다.
            즉 아래와 같이 전달받은 N값을 절반씩 나눌떄 짝수일 경우 그대로 2로 나누고, 홀수 일경우 +1한 상태로 2로 나눕니다. (최종적으로 +1 횟수가 건전지 사용량이다.)
            5 => 2(+1) .... 1 ... 0(+1)
            6 => 3 .... 1(+1)... 0(+1)
            5000 => 2500 => 1250 => 625 => 312(+1) => 156 => 78 => 39 => 19(+1) => 9(+1) => 4(+1) => 2 => 1 => 0(+1)
         */
        ...
        while (true) {
            if (n == 0) break;
            if (n % 2 != 0) k++; //홀수일 경우 건전지를 하나 사용해야 하므로 건전지 사용량 k값을 증가시킨다.
            n /= 2;
        }
