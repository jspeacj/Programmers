...
public class Level2_test1 {
    public static void main(String[] args) {
        ...
        큐는 먼저 집어넣은 원소가 먼저 나오는 구조입니다. (FIFO) => Queue
        ...
        for (int index = 0; index < queue1.length; index++) {
            queueOne.add(queue1[index]);
            queueTwo.add(queue2[index]);
            queue1Total += queue1[index];
            queue2Total += queue2[index];
        }

        num = (queue1Total + queue2Total) / 2; // 큐 원소 합의 기준
