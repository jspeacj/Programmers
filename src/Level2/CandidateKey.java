    ...
    public static void main(String[] args) {
        ...
        * */
        /*
            ...
            2. 해당 후보키를 다시 너비 우선 탐색 기법을 이용하여 기존 후보키를 모아둔 map을 통해 최소성을 만족하는지 분석한다.
            3. 최소성도 만족하고 유일성도 만족할 경우 map에다가 해당 후보키와 개수를 담는다.
            4. 해당 map에서 value값이 최대인 값이 후보 키의 최대 개수이다.
         */
