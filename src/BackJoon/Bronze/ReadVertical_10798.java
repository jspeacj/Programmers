...
public class ReadVertical_10798 {
    public static void main(String[] args) {
        ...
        char[] line1 = scan.next().toCharArray();
        char[] line2 = scan.next().toCharArray();
        char[] line3 = scan.next().toCharArray();
        char[] line4 = scan.next().toCharArray();
        char[] line5 = scan.next().toCharArray();

        for (int i = 0; i < 15; i++) {
            if (line1.length > i) sb.append(line1[i]);
            if (line2.length > i) sb.append(line2[i]);
            if (line3.length > i) sb.append(line3[i]);
            if (line4.length > i) sb.append(line4[i]);
            if (line5.length > i) sb.append(line5[i]);
        }
